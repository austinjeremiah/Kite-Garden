      ...
      >
        ...
        >
          ...
          <a href="/" className="flex items-center gap-2 group">
            <span className={`font-mono tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>KiteGarden</span>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            <Button
              variant="outline"
              className="flex-1 rounded-full h-14 text-base font-mono"
              onClick={() => setIsMobileMenuOpen(false)}
              asChild
            >
